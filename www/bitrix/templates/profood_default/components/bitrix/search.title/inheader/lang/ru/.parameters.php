...
$MESS["START_HIDDEN"] = "Поиск загружается скрытым";
$MESS["SHOW_SEARCHBAR"] = "Добавлять в верстку search-bar";
$MESS["JS_OPENER"] = "Использовать js скрытие/отображение";
$MESS["JS_OPENER_MOBILE"] = "Использовать js скрытие/отображение на мобильнике";
$MESS["WINDOW_WIDTH_MOBILE_OPENER_USE"] = "Ширина экрана для включения функционала скрытия/отображения";
