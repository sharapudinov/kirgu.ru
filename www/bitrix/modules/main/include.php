...
/*ZDUyZmZYTRmNTA0ODg0NDQwY2QwMWRmNjU4ZDhiZmJkNTMwMDc=*/$GLOBALS['____174761050']= array(base64_decode('ZG'.'Vm'.'a'.'W5l'));if(!function_exists(__NAMESPACE__.'\\___1348317265')){function ___1348317265($_175725724){static $_479056322= false; if($_479056322 == false) $_479056322=array(''.'RU5DT'.'0RF','WQ'.'==');return base64_decode($_479056322[$_175725724]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1671984175){ return true;} public static function IsFeatureEditable($_1671984175){ return true;} public static function SetFeatureEnabled($_1671984175, $_72412104= true){} public static function SaveFeaturesSettings($_640877663, $_1462973460){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1900338659){} public static function ModifyFeaturesSettings($_1900338659, $_2087513118){} public static function IsFeatureInstalled($_1671984175){ return true;}} $GLOBALS['____174761050'][0](___1348317265(0), ___1348317265(1));/**/			//Do not remove this
