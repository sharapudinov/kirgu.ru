...
{
	public static function GetTemplateParamsPropertiesList($IBLOCK_ID) {
	...
	public static function GetTemplateParamsCatalog($arCurrentValues=array()) {
		...
		if(CModule::IncludeModule('iblock') && CModule::IncludeModule('catalog')) {
			...
			// OFFERS FIELDS
			$arTemplateParams['OFFERS_FIELD_CODE'] = CIBlockParameters::GetFieldCode(GetMessage('RSDF.PARAM_OFFERS_FIELD_CODE'), 'ADDITIONAL_SETTINGS');
