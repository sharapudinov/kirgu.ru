...
$aTabs = array(
	array('DIV' => 'redsign_edit1', 'TAB' => GetMessage('RSDA2.TAB1_NAME'), 'ICON' => '', 'TITLE' => GetMessage('RSDA2.TAB1_TITLE')),
);
...
{
	COption::SetOptionString('redsign.daysarticle2', 'init_jquery', $_REQUEST['init_jquery']=='Y' ? 'Y' : 'N' );
}

$tabControl->Begin();

?><form method="post" name="redsign_daysarticle2_options" action="<?=$APPLICATION->GetCurPage()?>?mid=<?=urlencode($mid)?>&amp;lang=<?=LANGUAGE_ID?>"><?
