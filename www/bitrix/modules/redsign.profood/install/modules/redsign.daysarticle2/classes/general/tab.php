...
?><tr><?
	...
	?><td width="50%" class="adm-detail-content-cell-r"><?
		...
		?><select name="redsign_daysarticle2_discount_type"><?
			?><option value="Perc"<?if($data['VALUE_TYPE']=='P'):?> selected <?endif;?>><?=GetMessage('RSDA2.VALUE_TYPE_P')?></option><?
			?><option value="CurEach"<?if($data['VALUE_TYPE']=='C' || IntVal($data['ID'])<1):?> selected <?endif;?>><?=GetMessage('RSDA2.VALUE_TYPE_F')?></option><?
		?></select><?
	?></td><?
?></tr><?
?><tr><?
