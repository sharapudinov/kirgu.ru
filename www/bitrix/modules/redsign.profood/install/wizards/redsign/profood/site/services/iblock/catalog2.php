...
/*
$iblockXMLFileOffers = "/bitrix/modules/redsign.profood/install/public/xml/".LANGUAGE_ID."/catalog_sku.xml";
if ($shopLocalization == "ua")
	$iblockXMLFilePricesOffers = "/bitrix/modules/redsign.profood/install/public/xml/".LANGUAGE_ID."/catalog_prices_sku_ua.xml";
elseif ($shopLocalization == "bl")
	$iblockXMLFilePricesOffers = "/bitrix/modules/redsign.profood/install/public/xml/".LANGUAGE_ID."/catalog_prices_sku_bl.xml";
else
	$iblockXMLFilePricesOffers = "/bitrix/modules/redsign.profood/install/public/xml/".LANGUAGE_ID."/catalog_prices_sku.xml";
*/
...
$iblockCodeOffers = "profood_offers_".WIZARD_SITE_ID;
