...
<div id="ajaxpages_main_best" class="ajaxpages_main_best">
<?php
global $APPLICATION, $JSON, $isSorterChange, $isAjaxPages;

$isSorterChange = 'N';
if ($_REQUEST['AJAX_CALL'] == 'Y' && $_REQUEST['sorterchange'] == 'ajaxpages_main_best') {
	$isSorterChange = 'Y';
	$JSON['TYPE'] = 'OK';
}

$isAjaxPages = 'N';
if ($_REQUEST['ajaxpages'] == 'Y' && $_REQUEST['ajaxpagesid'] == 'ajaxpages_main_best') {
	$isAjaxPages = 'Y';
	$JSON['TYPE'] = 'OK';
}
?>
