...
$reviewsForumID = 0;
$dbRes = CForumNew::GetListEx(array(), array("SITE_ID" => WIZARD_SITE_ID, "XML_ID" => "PROFOOD_REVIEWS"));
if ($arRes = $dbRes->Fetch())
	$reviewsForumID = $arRes["ID"];

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/catalog/index.php', Array('COMMENTS_FORUM_ID' => $reviewsForumID));
