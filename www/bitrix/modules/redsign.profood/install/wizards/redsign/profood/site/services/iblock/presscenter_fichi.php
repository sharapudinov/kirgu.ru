...
if(COption::GetOptionString("redsign.profood", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "profood_fichi_".WIZARD_SITE_ID;
		...
		{
			WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", array("IBLOCK_ID_fichi" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/_all/fichi-'.LANGUAGE_ID.'.xml';
$iblockCode = "profood_fichi_".WIZARD_SITE_ID;
$iblockType = "presscenter"; 
