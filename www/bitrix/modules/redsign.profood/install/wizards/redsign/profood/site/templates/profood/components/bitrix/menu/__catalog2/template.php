...
if(is_array($arResult) && count($arResult)>0){
	?><div class="catalogmenu2_column"><?
		?><ul class="catalogmenu2 clearfix"><?
			...
			if($index>($max+1)){
				?><li class="first morelink lastchild"><a href="<?=$arParams['CATALOG_PATH']?>" class="first morelink"><?=GetMessage('RSGOPRO_MORE')?><svg class="svg-icon arrow"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-arrow-linear-right"></use></svg></a></li><?
			}
			?></ul></li><?
		?></ul><?
