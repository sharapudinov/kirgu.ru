...
*/
if (!in_array($wizrdTemplateId, array("profood")))
	$wizrdTemplateId = "profood";
...
{
	copy(WIZARD_ABSOLUTE_PATH."/site/templates//img/logo.png", WIZARD_SITE_PATH."include/logo.png");
	copy(WIZARD_ABSOLUTE_PATH."/site/templates//img/logo.png", WIZARD_SITE_PATH."include/logo_retina.png");
	___writeToAreasFile(WIZARD_SITE_PATH."include/company_logo.php", '<img src="'.WIZARD_SITE_DIR.'include/logo.png" srcset="'.WIZARD_SITE_DIR.'include/logo_retina.png 2x">');
}

@copy(WIZARD_ABSOLUTE_PATH."/site/templates//img/icon_fb.png", WIZARD_SITE_PATH."include/icon_fb.png");
@copy(WIZARD_ABSOLUTE_PATH."/site/templates//img/icon_tw.png", WIZARD_SITE_PATH."include/icon_tw.png");
@copy(WIZARD_ABSOLUTE_PATH."/site/templates//img/icon_vk.png", WIZARD_SITE_PATH."include/icon_vk.png");
