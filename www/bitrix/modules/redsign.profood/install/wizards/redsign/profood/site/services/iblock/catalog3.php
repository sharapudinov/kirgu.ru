...
if ($IBLOCK_OFFERS_ID)
{
	...
	// HL prop color
	//$arNewFields = array();
	//$res = CIBlockProperty::GetByID('COLOR_DIRECTORY',$IBLOCK_OFFERS_ID);
	//if ($arFields = $res->GetNext()) {
		//$arNewFields['USER_TYPE'] = $arFields['USER_TYPE'];
		//$arNewFields['USER_TYPE_SETTINGS']['TABLE_NAME'] = 'gopro_color_reference';
...
if ($IBLOCK_CATALOG_ID)
{
	...
	// HL prop brands
	$arNewFields = array();
	$res = CIBlockProperty::GetByID('BRAND', $IBLOCK_CATALOG_ID);
	if ($arFields = $res->GetNext()) {
		$arNewFields['USER_TYPE'] = $arFields['USER_TYPE'];
		$arNewFields['USER_TYPE_SETTINGS']['TABLE_NAME'] = 'profood_brand_reference';
	...
	// HL prop colors
	$arNewFields = array();
	$res = CIBlockProperty::GetByID('DISPLAY_COLOR', $IBLOCK_CATALOG_ID);
	if ($arFields = $res->GetNext()) {
		$arNewFields['USER_TYPE'] = $arFields['USER_TYPE'];
		$arNewFields['USER_TYPE_SETTINGS']['TABLE_NAME'] = 'gopro_color_reference';
...
*/
	...
	// #IBLOCK_ID_catalog#
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/_index.php', array('IBLOCK_ID_catalog' => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/auth/index.php', array('IBLOCK_ID_catalog' => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/brands/index.php', array('IBLOCK_ID_catalog' => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/catalog/index.php', array('IBLOCK_ID_catalog' => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/search/index.php', array('IBLOCK_ID_catalog' => $IBLOCK_CATALOG_ID));
  WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."personal/", array("IBLOCK_ID_catalog" => $IBLOCK_CATALOG_ID));
  WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", array("IBLOCK_ID_catalog" => $IBLOCK_CATALOG_ID));
	// offers
	// #IBLOCK_ID_offers#
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/catalog/index.php', array('IBLOCK_ID_offers' => $IBLOCK_OFFERS_ID));
  WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", array("IBLOCK_ID_offers" => $IBLOCK_OFFERS_ID));
}
