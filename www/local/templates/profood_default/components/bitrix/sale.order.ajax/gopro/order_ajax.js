	...
	BX.Sale.OrderAjaxComponent = {
		...
		getBlockFooter: function(node)
		{
			...
			if (!isLastNode)
			{
				buttons.push(
					BX.create('A', {
						props: {href: '', className: 'pull-right btn btn1'},
			...
			login = this.createAuthFormInputContainer(
				...
				BX.create('INPUT', {
					...
					props: {
						...
						maxlength: "30",
						placeholder: BX.message('STOF_LOGIN')
					},
			...
			password = this.createAuthFormInputContainer(
				...
				BX.create('INPUT', {
					...
					props: {
						...
						value: '',
						maxlength: "30",
						placeholder: BX.message('STOF_PASSWORD')
					},
					events: {keypress: BX.proxy(this.checkKeyPress, this)}
				})
			);
						...
						children: [
							// BX.create('LABEL', {
								...
								// children: [
									...
									BX.create('LABEL', {attrs: {for: 'USER_REMEMBER'}, props: {className: 'bx-filter-param-text'}, text: BX.message('STOF_REMEMBER')})
								// ]
							// })
						]
					})
		...
		editRegistrationForm: function(authContent)
		{
			...
			authFormNodes.push(this.createAuthFormInputContainer(
				...
				BX.create('INPUT', {
					...
					props: {
						...
						placeholder: BX.message('STOF_NAME')
					},
					events: {keypress: BX.proxy(this.checkKeyPress, this)}
				})
			));
			authFormNodes.push(this.createAuthFormInputContainer(
				...
				BX.create('INPUT', {
					...
					props: {
						...
						placeholder: BX.message('STOF_LASTNAME')
					},
					events: {keypress: BX.proxy(this.checkKeyPress, this)}
				})
			));
			authFormNodes.push(this.createAuthFormInputContainer(
				...
				BX.create('INPUT', {
					...
					props: {
						...
						placeholder: BX.message('STOF_EMAIL')
					},
					events: {keypress: BX.proxy(this.checkKeyPress, this)}
				})
			));
						...
						this.createAuthFormInputContainer(
							...
							BX.create('INPUT', {
								props: {
									...
									type: 'password',
									size: 30,
									placeholder: BX.message('STOF_RE_PASSWORD')
								},
								events: {
									keypress: BX.proxy(this.checkKeyPress, this)
								}
			...
			authFormNodes.push(
				BX.create('DIV', {
					props: {className: 'bx-authform-formgroup-container license-link-work'},
					children: [
						BX.create('DIV', {text: BX.message('LICENSE_WORK_LINK_PART1')}),
						BX.create('A', {attrs: {href: rsGoProLicenseWorkLink}, text: BX.message('LICENSE_WORK_LINK_PART2')})
					]
				})
			);
			authFormNodes.push(
				...
				for (i in this.result.PERSON_TYPE)
				{
					if (this.result.PERSON_TYPE.hasOwnProperty(i))
					{
						...
						*/
						/* custon */
						label = BX.create('LABEL', {
							attrs: {'for': 'choser_PERSON_TYPE' + currentType.ID},
							children: [
							// 	BX.create('I', {
							// 		attrs: {class: 'ico'}
							// 	}),
						...
						var labelInput = BX.create('INPUT', {
							attrs: {id: 'choser_PERSON_TYPE' + currentType.ID, checked: currentType.CHECKED == 'Y'},
							props: {type: 'radio', name: 'PERSON_TYPE', value: currentType.ID},
							events: {change: BX.proxy(this.sendRequest, this)}
						});
						...
						node.appendChild(BX.create('DIV', {props: {className: 'radio-inline'}, children: [labelInput, label]}));
						/* /custon */
						delimiter = true;
