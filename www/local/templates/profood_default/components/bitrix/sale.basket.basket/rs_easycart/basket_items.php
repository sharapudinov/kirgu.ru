						...
						?><td class="rsec_nowrap rsec_min rsec_padd"><?
							?><span class="rsec_quantity"><?
								?><span class="rsec_quantity__inner"><?
									?><a class="rsec_minus js-minus"></a><?
									?><input <?
										?>type="text" <?
										?>class="rsec_quantity__input js-quantity" <?
										?>name="QUANTITY_<?=$arItem['ID']?>" <?
										?>value="<?=$arItem['QUANTITY']?>" <?
										?>data-ratio="<?=$arItem['MEASURE_RATIO']?>" <?
										?>data-avaliable="<?=$arItem['AVAILABLE_QUANTITY']?>" /><?
									?><span class="rsec_measurename js-measurename"><?=$arItem['MEASURE_TEXT']?></span><?
									?><a class="rsec_plus js-plus"></a><?
								?></span><?
							?></span><?
						?></td><?
