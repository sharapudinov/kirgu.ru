					...
					foreach($arResult['GRID']['ROWS'] as $arItem)
					{
						...
						)
						{
							...
							?><tr class="js-element"><?
								...
								if ($arShowColumns['delete'] > 0) {
									?><td class="tc"><?
										?><a class="delete" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>" title="<?=GetMessage('SALE_DELETE')?>"><?
											?><svg class="svg-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-close-button"></use></svg><?
										?></a><?
									?></td><?
								}
								...
								if ($arShowColumns['delay'] > 0) {
									?><td class="tc"><?
										if ($mode=='') {
											?><a class="delay" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delay"])?>" title="<?=GetMessage('SALE_DELAY')?>"><?
												?><svg class="svg-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-clock"></use></svg><?
											?></a><?
										} elseif ( $mode=='delayed') {
											?><a class="add" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["add"])?>" title="<?=GetMessage('SALE_ADD_TO_BASKET')?>"><?
