...
if (file_exists($path = rsGoProGetTemplatePathPart(__DIR__.'/compare.start.php', $getTemplatePathPartParams))) {
	include($path);
}
...
if (file_exists($path = rsGoProGetTemplatePathPart(__DIR__.'/compare.finish.php', $getTemplatePathPartParams))) {
	include($path);
}
